...
router.post("/filter-record" , record.filterRecord)
router.post("/filter-recordbyissuedate" , record.filterByIssueDate)
router.post("/filter-recordbyduedate" , record.filterByDueDate)
